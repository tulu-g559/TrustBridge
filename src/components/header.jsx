    ...
    if (userType === "borrower") {
      return (
        <>
          ...
          {/* <Link to="/borrower/loans" className="text-gray-300 hover:text-white">My Loans</Link> */}
    ...
    if (userType === "lender") {
      return (
        <>
          ...
          {/* <Link to="/lender/requests" className="text-gray-300 hover:text-white">Loan Requests</Link> */}
        ...
        <div className="flex items-center">
          <Link to="/" className="flex items-center">
            <img
              ...
              className="h-15 w-auto pr-2 pt-[2px]"
            />
